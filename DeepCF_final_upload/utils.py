...
class BatchDataset(torch.utils.data.Dataset):
    def __init__(self, 
        ...
        self.item_embedding = torch.Tensor(item_embedding).long()
        self.user_embedding = torch.Tensor(user_embedding).long()
        self.labels = torch.Tensor(labels)
        
###########################################################################################################################
    def __getitem__(self, index):
        return self.userInput[index], self.itemInput[index], self.labels[index], self.item_embedding[index], self.user_embedding[index]
...
class TestDataset(torch.utils.data.Dataset):
    def __init__(self, userInput, itemInput, item_embedding
                ,user_embedding):
    ...
    def __getitem__(self, index):
        return self.userInput[index], self.itemInput[index], self.item_embedding[index], self.user_embedding[index] 
